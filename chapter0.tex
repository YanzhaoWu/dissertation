...
With the explosion of data and the increasing complexity of data analysis,
large-scale data analysis imposes significant challenges in systems design.
While current research focuses on scaling out to large clusters, these
scale-out solutions introduce a significant amount of overhead.
...
the impact of the new I/O technologies on large-scale data analysis.
...
i.e., keeping vertex state in memory and edges on SSDs,
